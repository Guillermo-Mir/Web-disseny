        ...
        >
            <header
                ...
                style={{
                    ...
                    boxShadow:
                        "inset 0 0 0 2000px rgba(120, 53, 15, 0.6)",
                }}
            >
            ...
            <section className="w-full max-w-3xl bg-white rounded-3xl shadow-2xl p-8 md:p-12 border-4 border-orange-200">
                <div className="text-center mb-10">
                    <h2 className="text-4xl font-serif font-extrabold text-gray-900 mb-2">
                        Escríbenos
                    </h2>
                ...
                <form className="flex flex-col gap-6">
                    <div>
                        ...
                        <input
                            ref={nombreRef} // Usa la referencia
                            type="text"
                    ...
                    <button
                        type="submit"
                        className="mt-4 bg-orange-500 hover:bg-orange-600 text-white font-serif font-bold text-xl py-4 rounded-2xl shadow-xl transition transform hover:scale-[1.02]"
                    >
                        Enviar Mensaje
                    </button>
                </form>
